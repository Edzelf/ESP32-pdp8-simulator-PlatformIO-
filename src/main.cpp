...
// 19-JUN-2023, ES  Continnue if no display found.                                              *
//***********************************************************************************************
//
#include <Arduino.h>
...
#define CACHESIZE 8                       // Was 16, caused overflow
#define PPS       21
...
void setup()
{
  ...
  if ( ota_enabled )
  {
    ...
    if ( p == nullptr )                                 // Enough space?
    {
      dbgprint ( "Memory allocation failure cach %d!", i ) ;
    }
    else
    {
